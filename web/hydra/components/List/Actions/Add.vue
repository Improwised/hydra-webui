<template>
  <div>
    ...
    <b-button class="add-btn" v-b-modal.add-model>Create Client</b-button>
    <b-modal id="add-model" ref="modal" title="Add Client" @ok="addModal">
      <form ref="form" @submit.prevent="add">
        ...
        >
          <b-form-input  id="name-input" v-model="form.owner" required></b-form-input>
        </b-form-group>
        <b-form-group
          label="Client Name"
          label-for="name-input"
        ...
        >
          <b-form-input id="name-input" :state="nameState" v-model="form.client_name" required></b-form-input>
        </b-form-group>
        <b-form-group
          label="Client Secret"
          label-for="name-input"
        ...
        >
          <b-form-input id="name-input" v-model="form.contacts" required></b-form-input>
        </b-form-group>
        <b-form-group
          label="Subject type"
          label-for="name-input"
        ...
        >
          <b-form-input id="name-input"  v-model="form.policy_uri" required></b-form-input>
        </b-form-group>
      </form>
    </b-modal>
  </div>
